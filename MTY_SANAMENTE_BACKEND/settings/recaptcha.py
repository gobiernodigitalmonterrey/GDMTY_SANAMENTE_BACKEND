...
RECAPTCHA_CREDENTIALS_SERVICE_ACCOUNT = service_account.Credentials.from_service_account_info(ast.literal_eval(os.getenv("RECAPTCHA_CREDENTIALS_SERVICE_ACCOUNT", "None")))
