...
CACHES = {
    "default": {
        "BACKEND": "gdmty_django_gcpmemorystore_cache.backends.redis.RedisCache",
        "LOCATION": "redis://10.200.0.18:6379/1",
    }
}

REDIS_MEMORYSTORE_CREDENTIALS = ast.literal_eval(os.getenv("REDIS_MEMORYSTORE_CREDENTIALS", "{}"))
